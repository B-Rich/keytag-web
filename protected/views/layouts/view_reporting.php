<?php $this->beginContent('//layouts/master_view_reporting'); ?>
    <div id="content-reporting" class="styled-report" >
        ...
        <span class="styled-bttn"><?php
            ...
            if( isset($this->isSurveyReport) && $this->isSurveyReport ) {
            	echo CHtml::linkButton('Export to Google Docs', array('submit' =>CController::createUrl('reports/surveyReport'), 'params'=>$_POST + array('google_export' => 1), 'id'=>'btnGoogleExport', 'class'=>'button-link')); 
            }
        ?>
        </span>
